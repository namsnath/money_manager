          ...
          return Column(
            children: [
              activityCards(
                context,
                title: 'Today',
                income: snapshot.data['debit']['day'],
                expense: snapshot.data['credit']['day'],
                balance: snapshot.data['balance']['day'],
              ),
              activityCards(
                context,
                title: 'This Week',
                income: snapshot.data['debit']['week'],
                expense: snapshot.data['credit']['week'],
                balance: snapshot.data['balance']['week'],
              ),
              activityCards(
                context,
                title: 'This Month',
                income: snapshot.data['debit']['month'],
                expense: snapshot.data['credit']['month'],
                balance: snapshot.data['balance']['month'],
              ),
              activityCards(
                context,
                title: 'This Year',
                income: snapshot.data['debit']['year'],
                expense: snapshot.data['credit']['year'],
